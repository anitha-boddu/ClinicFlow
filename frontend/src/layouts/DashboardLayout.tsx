    ...
    <div className="flex h-screen bg-[#F8FAFC]">
      ...
      <aside className="hidden lg:flex w-72 bg-white border-r border-gray-100 flex-col shadow-sm">
        <div className="p-8 pb-10 flex items-center gap-3">
          <div className="bg-[#E6F4FE] p-2 rounded-xl">
            <img src="/Logo-new.png" alt="ClinicFlow Logo" className="h-8 w-8 object-contain" />
          </div>
          <span className="font-black text-2xl tracking-tighter text-[#1E293B]">ClinicFlow</span>
        </div>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-100 z-50 flex items-center justify-between px-6">
        <div className="flex items-center gap-2">
          <img src="/Logo-new.png" alt="ClinicFlow Logo" className="h-6 w-6 object-contain" />
          <span className="font-black text-xl tracking-tighter">ClinicFlow</span>
        </div>
