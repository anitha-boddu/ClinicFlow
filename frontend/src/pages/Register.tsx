...
export default function Register() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Directly log in and redirect after registration
      ...
      <div className="w-full max-w-md bg-white rounded-xl shadow-xl overflow-hidden border border-gray-100 p-8 pt-10 relative">
        <div className="flex flex-col items-center mb-8">
           <div className="flex flex-col items-center gap-3 mb-6">
             <img src="/Logo-new.png" alt="ClinicFlow Logo" className="h-10 w-10 object-contain" />
             <span className="font-bold text-3xl text-[#0066CC]">ClinicFlow</span>
           </div>
          <h1 className="text-2xl font-bold text-gray-900 text-center">Create Account</h1>
          <p className="text-gray-500 mt-2 text-sm text-center">Select your role and join the ClinicFlow platform</p>
        </div>
